...
function SideBar() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1 font-semibold text-primary relative text-xl mb-10 justify-center">
          ...
          <li key={item.title}>
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                ` flex items-center gap-x-4 text-lg mb-8 py-2 hover:text-accent hover:cursor-pointer trasition-all ease-in-out duration-300 ${
                  isCollapsed ? 'px-8' : 'px-14'
                }`
              }
            >
              {item.icon}
