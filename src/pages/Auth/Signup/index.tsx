...
const SignUp = () => {
  const { signUp, signInWithGoogle, isAuth } = useAuth();
    ...
    <>
      <AppLayout>
        <div className="min-h-screen grid grid-cols-12">
          ...
          >
            <div className="flex items-center justify-center absolute top-0 left-0 right-0 bottom-0 bg-primary/70 dark:bg-black/80">
